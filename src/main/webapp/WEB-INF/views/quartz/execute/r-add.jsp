...
<head>
	...
	<script type="application/javascript">
		var quartzId="${quartzId}";
		if(quartzId!==""){
			quartzId=parseInt(quartzId);
		}
	</script>
</head>
<body class="gray-bg">
            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="quartzForm">
					<div class="form-group" style="display: none;">
						...
						<div class="col-sm-7">
							<input id="quartzId" readonly name="quartzId" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">执行策略：</label>
						<div class="col-sm-7">
							<input id="quartzCron" readonly name="quartzCron" placeholder="请选择定时任务的cron编码" class="form-control">
						</div>
					</div>
					<div class="form-group">
