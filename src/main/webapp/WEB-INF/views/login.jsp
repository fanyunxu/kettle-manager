...
<body class="login">
<div class="logo">
    <a href="javascript:void(0)"><span style="font-size: 24px;color: white;">kettle调度平台</span></a>
</div>
<div class="content">
...
<div class="copyright">2019 &copy; Kettle调度平台 By cmct.</div>
