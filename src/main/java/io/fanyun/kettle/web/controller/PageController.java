...
public class PageController {
	...
	@RequestMapping("quartz/execute/listUI.shtml")
	public String quartzExecuteListUI(){
		return "quartz/execute/list";
	}
	@RequestMapping("quartz/execute/r-add.shtml")
	public String quartzExecuteAdd(Integer quartzId, Model model){
		model.addAttribute("quartzId", quartzId);
		return "quartz/execute/r-add";
	}

	@RequestMapping("quartz/container/listUI.shtml")
	public String quartzContainerMonitorListUI(){
		return "quartz/container/list";
	}
