...
import io.fanyun.kettle.core.mapper.KJobMonitorDao;
import io.fanyun.kettle.core.mapper.KJobRecordDao;
import io.fanyun.kettle.core.model.po.KJobMonitor;
...
public class JobQuartz implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String jobPath = String.valueOf(jobDataMap.get(Constant.TRANSPATH));
		String jobName = String.valueOf(jobDataMap.get(Constant.TRANSNAME));
	...
	private void writeToDBAndFile(Object DbConnectionObject, KJobRecord kJobRecord, String logText)
		...
		kJobRecordDao.insertSelective(kJobRecord);
