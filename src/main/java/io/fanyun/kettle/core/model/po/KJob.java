package io.fanyun.kettle.core.model.po;
...
public class KJob {
	...
	public KJob(Integer jobId, Integer addUser, Integer delFlag, Integer editUser, Integer jobRecord, Integer jobQuartz,
			Integer jobRepositoryId, Integer jobStatus, Integer jobType, String jobDescription, String jobName,
			String jobPath, String jobLogLevel, Date addTime, Date editTime) {
		super();
		this.jobId = jobId;
		this.addUser = addUser;
		this.delFlag = delFlag;
	...
	public String toString() {
		return "KJob [jobId=" + jobId + ", addUser=" + addUser + ", delFlag=" + delFlag + ", editUser=" + editUser
				+ ", jobRecord=" + jobRecord + ", jobQuartz=" + jobQuartz + ", jobRepositoryId=" + jobRepositoryId
				+ ", jobStatus=" + jobStatus + ", jobType=" + jobType + ", jobDescription=" + jobDescription
				+ ", jobName=" + jobName + ", jobPath=" + jobPath + ", jobLogLevel=" + jobLogLevel + ", addTime="
