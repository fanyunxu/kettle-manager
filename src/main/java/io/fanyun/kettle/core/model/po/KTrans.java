...
public class KTrans {
	...
	public String toString() {
		return "KTrans [transId=" + transId + ", addUser=" + addUser + ", delFlag=" + delFlag + ", editUser=" + editUser
				+ ", transQuartz=" + transQuartz + ", transRecord=" + transRecord + ", transRepositoryId="
				+ transRepositoryId + ", transStatus=" + transStatus + ", transType=" + transType
				+ ", transDescription=" + transDescription + ", transLogLevel=" + transLogLevel + ", transName="
				+ transName + ", transPath=" + transPath + ", addTime=" + addTime + ", editTime=" + editTime + "]";
	}
}